...
const NotifySet = ({notify, setNotify})=>{
    const [notifySet, setNotifySet] = useContext(NotifyContext);
    const [indicator, setIndicator] = useState(notify);
    ...
    return (
        <View style={styles.container}>
            <Text style={{fontSize: 25, backgroundColor: "black", color:"white", width: "100%", paddingLeft: "10%", borderWidth: 4, borderColor: "#003399" }}>Notifications Settings</Text>
